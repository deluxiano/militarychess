...
const RailroadNetwork_1 = require("./RailroadNetwork");
...
class Board {
    ...
    */
    constructor() {
        this.boardState = {
            a12: new Piece_1.Piece('r', '10'), b12: new Piece_1.Piece('r', '11'), c12: new Piece_1.Piece('r', '10'), d12: new Piece_1.Piece('r', '0'), e12: new Piece_1.Piece('r', '0'),
            a11: new Piece_1.Piece('r', '9'), b11: new Piece_1.Piece('r', '10'), c11: new Piece_1.Piece('r', '9'), d11: new Piece_1.Piece('r', '2'), e11: new Piece_1.Piece('r', '9'),
            a10: new Piece_1.Piece('r', '6'), b10: null, c10: new Piece_1.Piece('r', '6'), d10: null, e10: new Piece_1.Piece('r', '5'),
            a9: new Piece_1.Piece('r', '1'), b9: new Piece_1.Piece('r', '3'), c9: null, d9: new Piece_1.Piece('r', '3'), e9: new Piece_1.Piece('r', '5'),
            a8: new Piece_1.Piece('r', '8'), b8: null, c8: new Piece_1.Piece('r', '8'), d8: null, e8: new Piece_1.Piece('r', '8'),
            a7: new Piece_1.Piece('r', '7'), b7: new Piece_1.Piece('r', '7'), c7: new Piece_1.Piece('r', '7'), d7: new Piece_1.Piece('r', '4'), e7: new Piece_1.Piece('r', '4'),
            a6: new Piece_1.Piece('b', '7'), b6: new Piece_1.Piece('b', '2'), c6: new Piece_1.Piece('b', '7'), d6: new Piece_1.Piece('b', '3'), e6: new Piece_1.Piece('b', '7'),
            a5: new Piece_1.Piece('b', '4'), b5: null, c5: new Piece_1.Piece('b', '5'), d5: null, e5: new Piece_1.Piece('b', '4'),
            a4: new Piece_1.Piece('b', '8'), b4: new Piece_1.Piece('b', '3'), c4: null, d4: new Piece_1.Piece('b', '1'), e4: new Piece_1.Piece('b', '8'),
            a3: new Piece_1.Piece('b', '6'), b3: null, c3: new Piece_1.Piece('b', '8'), d3: null, e3: new Piece_1.Piece('b', '5'),
            a2: new Piece_1.Piece('b', '9'), b2: new Piece_1.Piece('b', '10'), c2: new Piece_1.Piece('b', '10'), d2: new Piece_1.Piece('b', '9'), e2: new Piece_1.Piece('b', '9'),
            a1: new Piece_1.Piece('b', '0'), b1: new Piece_1.Piece('b', '11'), c1: new Piece_1.Piece('b', '10'), d1: new Piece_1.Piece('b', '0'), e1: new Piece_1.Piece('b', '6')
        };
        this.nodeKeys = Object.keys(this.boardState);
        this.railroadNetwork = new RailroadNetwork_1.RailroadNetwork(RAIL_LINES);
    }
    /**
    ...
    isPlayerFlagCaptured(playerColor) {
        return !doesPieceExist(this.boardState, playerColor, Piece_1.RANK_FLAG);
    }
    ;
    /**
    ...
    isCommanderAlive(playerColor) {
        return doesPieceExist(this.boardState, playerColor, Piece_1.RANK_COMMANDER);
    }
    ;
    ...
    getValidMoves(square, board) {
        ...
        var isPieceEngineer = (piece.getRank() === Piece_1.RANK_ENGINEER);
...
var isDestinationPositionValid = function (pieceRank, current, destination) {
    ...
    if (pieceRank == Piece_1.RANK_BOMB) {
        return isValidBombPosition(destRowNum);
    }
    else if (pieceRank == Piece_1.RANK_LANDMINE) {
        return isValidLandminePosition(destRowNum);
    }
    else if (pieceRank == Piece_1.RANK_FLAG) {
